...
public class SoundGeneratorPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    final EventChannel onChangeIsPlayingNoise = new EventChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), isPlayingStreamNoiseHandler.NATIVE_CHANNEL_EVENT);
...
//      soundGenerator.startPlayback();
      ...
      soundGenerator.startnoisePlayback();
    }else if (call.method.equals("stop_noise")) {
      soundGenerator.stopnoisePlayback();
